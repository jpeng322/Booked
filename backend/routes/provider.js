...
router.get("/provider", passport.authenticate("jwt", { session: false }),
async (req, res) => {
    try {
        const providers = await prisma.provider.findMany({
            where: {
...
app.post('/providers', passport.authenticate("jwt", { session: false }), 
async (req, res) => {
...
app.put('/providers/:id', passport.authenticate("jwt", { session: false }), 
async (req, res) => {
...
app.delete('/providers/:id', passport.authenticate("jwt", { session: false }),
